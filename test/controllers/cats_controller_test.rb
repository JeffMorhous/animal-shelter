...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference("Cat.count") do
      post cats_url, params: { cat: { arrival_date: @cat.arrival_date, description: @cat.description, name: @cat.name } }, as: :json
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { arrival_date: @cat.arrival_date, description: @cat.description, name: @cat.name } }, as: :json
    assert_response :success
  end
